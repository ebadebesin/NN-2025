...
class NeuralNetworkTrainer:
    ...
    def __init__(self, model, X_train, y_train, X_test, y_test, learning_rate=0.001, epochs=500, clip_value=1.0):
        """
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            # Forward pass
            output = self.model.forwardProp(self.X_train)
...
if __name__ == "__main__":
    ...
    layer_sizes = [input_size, 64, 32, 16, 8, 1]  # Input -> hidden layers -> binary output
    ...
    trainer = NeuralNetworkTrainer(dnn, X_train, y_train, X_test, y_test, learning_rate=0.005, epochs=200, clip_value=1.0)
